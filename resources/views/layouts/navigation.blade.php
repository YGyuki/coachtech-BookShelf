<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    {{-- <x-nav-link :href="route('reading-plans.index')"
                        :active="request()->routeIs('reading-plans.*')">
                        {{ __('読書計画') }}
                    </x-nav-link> --}}
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            {{-- <x-responsive-nav-link :href="route('reading-plans.index')"
                :active="request()->routeIs('reading-plans.*')">
                {{ __('読書計画') }}
            </x-responsive-nav-link> --}}
            @auth
                {{-- <x-responsive-nav-link :href="route('notifications.index')"
                    ...
                    {{ __('通知') }}@if($unreadNotificationCount > 0) <span
                        ...
                        $unreadNotificationCount }}</span>@endif
                </x-responsive-nav-link> --}}
            @endauth
        </div>
